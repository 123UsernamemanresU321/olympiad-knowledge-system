...
This frontend renders authored knowledge from `content/`, supports LaTeX visualization in the main study surfaces, and can authenticate against Supabase for login, admin routing, and optional progress sync.
...
The SQL bootstrap does two important things:
